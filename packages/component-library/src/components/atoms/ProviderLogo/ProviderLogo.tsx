...
/** OpenAI logo - official mark from lobehub/icons */
const OpenAILogo = () => (
...
/** Anthropic logo - official mark from simple-icons */
const AnthropicLogo = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="h-full w-full">
...
/** Google Gemini logo - official 4-point star from simple-icons */
const GoogleLogo = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="h-full w-full">
...
/** xAI Grok logo - official mark from lobehub/icons */
const XAILogo = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" className="h-full w-full">
...
/** DeepSeek logo - official mark from lobehub/icons */
const DeepSeekLogo = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="h-full w-full">
